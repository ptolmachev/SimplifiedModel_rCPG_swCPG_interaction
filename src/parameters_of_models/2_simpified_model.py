# a script which generates parameters for the "model 2"
import numpy as np
import pickle
...
def generate_paramconfig_full_model():
    ...
    pnames = ["Insp", "Exp", "Sw1", "Sw2", "Sensory_relay", "KF_phasic", "KF_gate"]
    N = len(pnames)
    ...
    pickle.dump(param_dict, open(os.path.join(params_folder, "params_model_simplified.pkl"), 'wb+'))
    return None
