# a script which generates parameters for the "model 3"
import numpy as np
import pickle
...
def generate_paramconfig_full_model():
    ...
    W[pnames.index("Sensory_relay"), pnames.index("LateExp")] = -0.4
    ...
    pickle.dump(param_dict, open(os.path.join(params_folder, "params_model_intermediate.pkl"), 'wb+'))
    return None
