...
if __name__ == '__main__':
    ...
    parameters_to_vary = [
        # "self.model.W[self.model.pnames.index(\"Sensory_relay\"),self.model.pnames.index(\"Sw1\")]",
        # "self.model.W[self.model.pnames.index(\"Sensory_relay\"),self.model.pnames.index(\"Sw2\")]",
        # "self.model.W[self.model.pnames.index(\"Sensory_relay\"),self.model.pnames.index(\"Insp\")]",
        # "self.model.W[self.model.pnames.index(\"Sensory_relay\"),self.model.pnames.index(\"LateExp\")]",
        ...
        # "self.model.W[self.model.pnames.index(\"Sw1\"),self.model.pnames.index(\"LateExp\")]",
        ...
        # "self.model.W[self.model.pnames.index(\"Insp\"),self.model.pnames.index(\"KF_phasic\")]",
        ...
        # "self.model.W[self.model.pnames.index(\"LateExp\"),self.model.pnames.index(\"KF_phasic\")]",
        # "self.model.W[self.model.pnames.index(\"KF_phasic\"),self.model.pnames.index(\"Exp\")]",
        # "self.model.W[self.model.pnames.index(\"KF_gate\"),self.model.pnames.index(\"Sw1\")]",
    ...
    for i, parameter_to_vary in enumerate(parameters_to_vary):
        ...
        description = f"Varying the {hr_param_name} in the range (0.1 - 1.5) * param_val"
        ...
        config_dict["param_points"] = np.linspace(0.1 * param_val, 1.5 * param_val, 50).reshape(-1, 1)
