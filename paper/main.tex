...
A further challenge is that the connection weights our model posits are underconstrained: reproducing the observed motor patterns and a handful of experimental observations does not uniquely determine them.
